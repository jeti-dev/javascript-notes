...
| **contentSecurityPolicy**     | Sets `Content-Security-Policy` header to restrict the sources of content that can be loaded (like scripts, styles, images). e.g. js files can be loaded only from the same site but styles can be loaded from some CDN                                                                           |
